...
function socioEconomic(newValue){ 
    ...
    let bubbleLayout = {
        ...
        yaxis: {title: newValue.replace(/_/g, " ")},
        xaxis: {title: "percent_frequent_mental_distress".replace(/_/g, " ")},
        margin: {t: 50, b: 50},
        showlegend: false
      };
...
//         yaxis: {title: yval.replace(/_/g, " ")},
//         xaxis: {title: xval.replace(/_/g, " ")},
//         margin: {t: 50, b: 50},
//         showlegend: false
//     };    
//     // Plotly to plot the data with the layout.
